...
# device_alo = cuda.get_current_device()
# device_alo.reset()#reset graph
# def get_gpu_memory():
...
if __name__ == '__main__':
    ...
    place="/0-25/"
    # place = "/test_images/"
    #source_machine = 'E:/DO AN TIN HOC/NWPU-Crowd_C3/code matlab/destination' + place
    source_machine = 'E:/DO AN TIN HOC/NWPU-Crowd_C3/code matlab/destination' + place
    destination = 'E:/DO AN TIN HOC/NWPU-Crowd_C3/code matlab/destination/predicted_output/'
    mylist = os.listdir(source_machine)
    file_name = destination + place[:-1] + '_predicted.txt'
    num_images = len(mylist)
    with open(file_name, 'w') as f_machine:
        for i in mylist:
